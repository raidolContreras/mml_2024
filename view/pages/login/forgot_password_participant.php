            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="forgotPassFormsParticipant" method="POST">
                            <div class="form-group">
                                <label for="emailParticipant" id="email-label">Email Address</label>
                                <input type="email" id="emailParticipant" class="form-control" required>
                            </div>
                        ...
                        <div class="text-center mt-3">
                            <a href="participant_login" id="back-to-login"></a>
                        </div>
                    </div>
                </div>
            </div>
